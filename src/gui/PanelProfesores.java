...
public class PanelProfesores extends JPanel {
	...
	private void initialize() {
		...
		btnNuevo.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/añadir.png")));
		...
		btnPrimero.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/primero.png")));
		...
		btnAnterior.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/anterior.png")));
		...
		btnGuardar.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/guardar.png")));
		...
		btnSiguiente.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/siguiente.png")));
		...
		btnUltimo.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/ultimo.png")));
		...
		btnEliminar.setIcon(new ImageIcon(PanelProfesores.class.getResource("/images/eliminar.png")));
